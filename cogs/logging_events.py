...
-------------------------
Requirement #8 (το γενικό κομμάτι - τα command logs είναι στο moderation.py,
τα application logs στο applications.py, τα staff-activity logs στο
staff_activity.py).

Καλύπτει:
    - Join / Leave (στο ΙΔΙΟ channel)
    - Role changes (ξεχωριστό channel)
    - Channel create/delete/edit (ξεχωριστό channel)
    - Message edit/delete (ξεχωριστό channel)
    - Voice join/leave/move (ξεχωριστό channel)
Όλα τα embeds έχουν thumbnail = το εικονίδιο του server.
"""
